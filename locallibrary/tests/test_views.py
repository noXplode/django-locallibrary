...
class AuthorListViewTest(TestCase):
    ...
    def test_view_url_exists_at_desired_location(self):
        response = self.client.get('/locallibrary/authors/')
    ...
    def test_view_uses_correct_template(self):
        response = self.client.get(reverse('authors'))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'locallibrary/author_list.html')
...
from locallibrary.models import BookInstance, Book, Genre, Language
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def test_redirect_if_not_logged_in(self):
        ...
        self.assertRedirects(response, '/accounts/login/?next=/locallibrary/mybooks/')
...
class AuthorCreateViewTest(TestCase):
    ...
    def test_redirect_if_not_logged_in(self):
        ...
        self.assertRedirects(response, '/accounts/login/?next=/locallibrary/author/create/')
    ...
    def test_redirects_to_detail_view_on_success(self):
        ...
        self.assertEqual(response.status_code, 302)
        self.assertTrue(response.url.startswith('/locallibrary/author/'))    